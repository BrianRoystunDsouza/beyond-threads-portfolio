...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      href="https://wa.me/919XXXXXXXXX?text=Hi%20Prapti!%20I'd%20love%20to%20place%20a%20custom%20order%20from%20Beyond%20Threads!"
      target="_blank"
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-xl shadow-green-400/40 hover:shadow-green-400/60 transition-shadow"
