...
const testimonials = [
  {
    name: 'Ananya Sharma',
    location: 'Mumbai',
    text: "Ordered a custom amigurumi bear for my daughter's first birthday and I was blown away. The quality, the softness, the detail — it became her favourite toy instantly. Prapti is absolutely gifted.",
    rating: 5,
    avatar: 'AS',
    item: 'Custom Amigurumi Bear',
  },
  {
    name: 'Riya Menon',
    location: 'Bangalore',
    text: "The crochet flower bouquet I ordered was a gift for my mom on her anniversary. She cried happy tears. Prapti captured exactly the colors I wanted and delivered ahead of time. Truly a gem!",
    rating: 5,
    avatar: 'RM',
    item: 'Flower Bouquet',
  },
  ...
  },
  {
    name: 'Priya Nair',
    location: 'Pune',
    text: "I've ordered three times now and every single piece has exceeded expectations. The packaging alone is so thoughtful — I almost didn't want to open it! These are heirlooms, not just gifts.",
    rating: 5,
    avatar: 'PN',
